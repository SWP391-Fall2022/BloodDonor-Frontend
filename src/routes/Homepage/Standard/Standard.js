...
const Standard = () => {
  ...
  return (
    <section className="standard" data-aos="slide-up">
      ...
      <div className="container-standard">
        ...
        <div className="standard-card" >
          ...
          <p>
            Chỉ số huyết sắc tố <br /> Hb ≥120g/l và Hb ≥125g/l nếu hiến từ
            350ml trở lên
          </p>
        </div>
        {/* ===6=== */}
        <div className="standard-card" >
          ...
          <p>
            Không mắc hay có nguy cơ lây nhiễm HIV, không bị viêm gan B hay C, và các virus lây qua máu.
          </p>
        </div>
        {/* ===7=== */}
        <div className="standard-card" >
          ...
          <p>
            Cân nặng: <br /> Nam ≥ 45 kg | Nữ ≥ 42 kg
          </p>
        </div>
        {/* ===8=== */}
        <div className="standard-card" >
